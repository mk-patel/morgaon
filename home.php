...
$sql1www = "SELECT * FROM notification where user_id='$mid' and user_seen='1'";
$result2tt = mysqli_query($conn, $sql1www);
$rowcount1=mysqli_num_rows($result2tt);
$row999=mysqli_fetch_array($result2tt);
...
<div class="d-flex justify-content-between" style="width:100%;height:auto;margin-top:10px;font-size:10px;">
      <div class="footer-but" style="width:20%;font-weight:800;margin-top:10px;margin-bottom:10px;">    
       <a href="khairjhiti kalashop.php?eid=<?php echo $gaon1; ?>"><img src="images/shop1.jpg" alt="shop" width="40px" height="40px"><br>दुकान<br>( Shop ) </a> 
      </div>
      <div class="footer-but" style="width:20%;font-weight:800;margin-top:10px;margin-bottom:10px;">    
       <a href="tution.php?eid=<?php echo $gaon1; ?>"><img src="images/tution.jpg" alt="tution" width="40px" height="40px"><br>शिक्षण सुविधा<br>( Tution )</a> 
      </div>
      <div class="footer-but" style="width:20%;font-weight:800;margin-top:10px;margin-bottom:10px;">    
       <a href="bus.php?eid=<?php echo $gaon1; ?>"><img src="images/bus.jpg" alt="Bus" width="40px" height="40px"><br>बस सुविधा<br>( Bus )</a> 
      </div>
     <div class="footer-but" style="width:20%;font-weight:800;margin-top:10px;margin-bottom:10px;">
        <a href="khairjhitidetails.php?eid=<?php echo $gaon1; ?>" ><img src="images/village.jpg" alt="village" width="40px" height="40px"><br>जानकारी<br>( Village Info )</a>
      </div>
</div>
...
<div class="dukan" style="background:orange; width:100%;height:30px;line-height:30px;border-radius:7px;color:white;">हाल ही में ( वर्तमान में ) <?php echo $gaon1 ?> में</div>
...
<input type="hidden" id="vill" value="<?php echo $gaon1; ?>">
</form>
...
$query = "select * from khairjhitikalan inner join users on khairjhitikalan.user_id=users.id where khairjhitikalan.gaon='$gaon1' order by khairjhitikalan.id1 desc limit 0,4";
...
?>
<a href="showallkhairjhitikala.php?eid=<?php echo $gaon1; ?>"><button type="button" class="btn btn-warning" style="color:white;font-weight:800;">सभी देखें</button></a>
</div><br>
<script type = "text/javascript">
...
<input type="hidden" id="vill1" value="<?php echo $gaon1; ?>">
</form>
<hr style="border:1px solid grey">
</div>
</div>
...
?>
<a href="showall.php?eid=<?php echo $gaon1; ?>"><button type="button" class="btn btn-warning" style="color:white;font-weight:800;">सभी देखें</button></a>
  <br>
</div>
...
<nav class="navbar navbar-expand-sm bg-light navbar-dark fixed-bottom">
 <div class="d-flex justify-content-between" style="width:100%;height:auto;">
      <div class="footer-but" style="width:20%;font-weight:800;">    
       <a href="khairjhiti kalashop.php?eid=<?php echo $gaon1; ?>"><img src="images/shop.png" alt="shop" width="30px" height="30px"><br>दुकान</a> 
      </div>
      <div class="footer-but" style="width:20%;font-weight:800;">
        <a href="khairjhitidetails.php?eid=<?php echo $gaon1; ?>" ><img src="images/village.png" alt="village" width="30px" height="30px"><br>जानकारी</a>
      </div>
      <div class="footer-but" style="width:20%;font-weight:800;">
