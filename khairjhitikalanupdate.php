...
$eid=$_REQUEST["eid"];
$query="SELECT * FROM khairjhitikalan where id1='$eid' && user_id='$tid'";
$result=mysqli_query($conn,$query);
$row=mysqli_fetch_assoc($result);
...
if(isset($_POST["submit"]))
{
	$title=$_POST["title"];
	$data= $_POST["data"];
	$query1="UPDATE khairjhitikalan SET title='$title' , data='$data' where id1='$eid'";
...
<div class="form-group">
    ...
    <textarea class="form-control" name="data" rows="5"><?php echo htmlspecialchars($row["data"], ENT_QUOTES, 'UTF-8');?></textarea required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
