...
if(isset($_REQUEST["delid"]))
{
	...
	$success = "delete from users where id='$delid'";
...
?>
	 ...
	 <p style=" font-weight:600;"><?php echo htmlspecialchars($row0["id"], ENT_QUOTES, 'UTF-8');?> . <?php echo htmlspecialchars($row0["username"], ENT_QUOTES, 'UTF-8');?> , <?php echo htmlspecialchars($row0["email"], ENT_QUOTES, 'UTF-8');?></p>
	 <p style=" font-weight:600;">Name : <?php echo htmlspecialchars($row0["name"], ENT_QUOTES, 'UTF-8');?></p>
	 <p style=" font-weight:600;">Village : <?php echo htmlspecialchars($row0["village"], ENT_QUOTES, 'UTF-8');?></p>
     <p style=" font-weight:600;">Verification Code : <?php echo htmlspecialchars($row0["vcode"], ENT_QUOTES, 'UTF-8');?></p>
	 <p><a href="members.php?delid=<?php echo $row0["id"]; ?>"><p>Delete</p></a></p>
	 </div>
	 <hr/>
	 <br>
<?php
