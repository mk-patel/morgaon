...
$sql=mysqli_query($conn, "select user_id from khairjhitikalan where id1='$name'");
...
$user_id = $row['user_id'];
 $insert=mysqli_query($conn,"insert into comments (type,name,comment,post_id,user_id,date2,date1) values('$type','$nu','$comment','$name','$mid','$dt2','$dt1')");
  mysqli_query($conn, "insert into notification(name,user_id,post_id,type,post_type,date1,date2) values ('$nu','$user_id','$name','commented on','showmore.php','$dt2','$dt1')");
