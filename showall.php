...
<nav class="navbar navbar-expand-md bg-primary navbar-light">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item" style="font-weight:800;">
        <a href="login.php"> <button type="button" class="btn btn-warning" style="color:white;font-weight:800;">Login Kare</button></a>
      </li>
	  &nbsp; &nbsp;
      <li class="nav-item" style="font-weight:800;">
...
<?php
$query= "select * from post inner join users on post.user_id=users.id order by post.id1 desc limit 0,20";
